# Global Time Viewer v3.10.2

## 최근 업데이트 (v3.10.2)
- 사용자 지정 시간대(Custom Timezone)의 UTC 오프셋이 정상적으로 반영되도록 수정했습니다.
- 고정 시간 탭의 시간대 테이블에서 항목 순서 조정(드래그 앤 드롭) 기능을 제거했습니다.
- 전체 코드베이스의 유지보수성 향상과 최적화를 진행했습니다.
## 주요 기능
