...
function loadMainMultiRangeTabFacadeModule({ withWindow = true } = {}) {
    ...
    const keys = ["window", "console", "GTVMainMultiRangeTabFacade", ...Object.keys(globalPatches)];
    ...
    return globalThis.window?.GTVMainMultiRangeTabFacade
        || globalThis.GTVMainMultiRangeTabFacade;
}
