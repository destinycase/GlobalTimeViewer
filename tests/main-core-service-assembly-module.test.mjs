...
function loadMainCoreServiceAssemblyModule() {
    ...
    vm.runInContext(code, sandbox, { filename: "js/modules/main-core-service-assembly.js" });
    return sandbox.window.GTVMainCoreServiceAssembly
        || sandbox.GTVMainCoreServiceAssembly
        || sandbox.globalThis.GTVMainCoreServiceAssembly;
}
