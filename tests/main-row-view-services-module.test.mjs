...
function loadMainRowViewServicesModule() {
    ...
    vm.runInContext(code, sandbox, { filename: "js/modules/main-row-view-services.js" });
    return sandbox.window.GTVMainRowViewServices
        || sandbox.GTVMainRowViewServices
        || sandbox.globalThis.GTVMainRowViewServices;
}
