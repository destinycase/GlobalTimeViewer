...
function loadMainPersistenceSnapshotServicesModule() {
    ...
    vm.runInContext(code, sandbox, { filename: "js/modules/main-persistence-snapshot-services.js" });
    return sandbox.window.GTVMainPersistenceSnapshotServices
        || sandbox.GTVMainPersistenceSnapshotServices
        || sandbox.globalThis.GTVMainPersistenceSnapshotServices;
}
