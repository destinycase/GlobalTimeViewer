...
function loadMainRuntimeCompositionServicesModule() {
    ...
    vm.runInContext(code, sandbox, { filename: "js/modules/main-runtime-composition-services.js" });
    return sandbox.window.GTVMainRuntimeCompositionServices
        || sandbox.GTVMainRuntimeCompositionServices
        || sandbox.globalThis.GTVMainRuntimeCompositionServices;
}
