...
function loadMainTimeAdjustFacadeModule({ withWindow = true } = {}) {
    ...
    vm.runInContext(code, sandbox, { filename: "js/modules/main-time-adjust-facade.js" });
    return sandbox.window?.GTVMainTimeAdjustFacade
        || sandbox.GTVMainTimeAdjustFacade
        || sandbox.globalThis.GTVMainTimeAdjustFacade;
}
