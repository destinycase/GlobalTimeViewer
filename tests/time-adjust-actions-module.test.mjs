...
function loadTimeAdjustActionsModule() {
    ...
    vm.runInContext(code, sandbox, { filename: "js/modules/time-adjust-actions.js" });
    return sandbox.window.GTVTimeAdjustActions || sandbox.GTVTimeAdjustActions || sandbox.globalThis.GTVTimeAdjustActions;
}
