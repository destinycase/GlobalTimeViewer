...
function loadMainTimezoneMutationServicesModule() {
    ...
    vm.runInContext(code, sandbox, { filename: "js/modules/main-timezone-mutation-services.js" });
    return sandbox.window.GTVMainTimezoneMutationServices
        || sandbox.GTVMainTimezoneMutationServices
        || sandbox.globalThis.GTVMainTimezoneMutationServices;
}
